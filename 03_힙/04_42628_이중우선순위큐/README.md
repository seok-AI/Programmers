...
```bash
python3 tools/judge.py "03_힙/04_42628_이중우선순위큐"
```

채점기는 `operations` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "03_힙/04_42628_이중우선순위큐/solution.py"
```
