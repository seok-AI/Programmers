...
```bash
python3 tools/judge.py "07_동적계획법/03_42898_등굣길"
```

채점기는 `m`, `n`, `puddles` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "07_동적계획법/03_42898_등굣길/solution.py"
```
