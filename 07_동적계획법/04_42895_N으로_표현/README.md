...
```bash
python3 tools/judge.py "07_동적계획법/04_42895_N으로_표현"
```

채점기는 `N`, `number` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "07_동적계획법/04_42895_N으로_표현/solution.py"
```
