...
```bash
python3 tools/judge.py "07_동적계획법/02_43105_정수_삼각형"
```

채점기는 `triangle` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "07_동적계획법/02_43105_정수_삼각형/solution.py"
```
