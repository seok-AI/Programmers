...
- 함수: `solution(priorities, location)`
...
```bash
python3 tools/judge.py "02_스택_큐/05_42587_프로세스"
```

채점기는 `priorities`, `location` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "02_스택_큐/05_42587_프로세스/solution.py"
```
