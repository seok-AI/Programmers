...
- 함수: `solution(bridge_length, weight, truck_weights)`
...
```bash
python3 tools/judge.py "02_스택_큐/06_42583_다리를_지나는_트럭"
```

채점기는 `bridge_length`, `weight`, `truck_weights` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "02_스택_큐/06_42583_다리를_지나는_트럭/solution.py"
```
