...
- 함수: `solution(s)`
- 포함된 테스트: 공식 공개 예제 4개 + 자체 경계 사례 2개
...
```bash
python3 tools/judge.py "02_스택_큐/02_12909_올바른_괄호"
```

채점기는 `s` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "02_스택_큐/02_12909_올바른_괄호/solution.py"
```
