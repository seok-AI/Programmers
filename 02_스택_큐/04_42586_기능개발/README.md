...
```bash
python3 tools/judge.py "02_스택_큐/04_42586_기능개발"
```

채점기는 `progresses`, `speeds` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "02_스택_큐/04_42586_기능개발/solution.py"
```
