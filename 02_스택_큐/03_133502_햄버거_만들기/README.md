...
```bash
python3 tools/judge.py "02_스택_큐/03_133502_햄버거_만들기"
```

채점기는 `ingredient` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "02_스택_큐/03_133502_햄버거_만들기/solution.py"
```
