...
```bash
python3 tools/judge.py "05_완전탐색/06_87946_피로도"
```

채점기는 `k`, `dungeons` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "05_완전탐색/06_87946_피로도/solution.py"
```
