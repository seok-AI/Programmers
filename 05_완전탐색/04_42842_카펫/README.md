...
```bash
python3 tools/judge.py "05_완전탐색/04_42842_카펫"
```

채점기는 `brown`, `yellow` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "05_완전탐색/04_42842_카펫/solution.py"
```
