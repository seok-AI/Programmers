...
- 공식 문제: <https://school.programmers.co.kr/learn/courses/30/lessons/86971>
- 함수: `solution(n, wires)`
...
```bash
python3 tools/judge.py "05_완전탐색/07_86971_전력망을_둘로_나누기"
```

채점기는 `n`, `wires` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "05_완전탐색/07_86971_전력망을_둘로_나누기/solution.py"
```
