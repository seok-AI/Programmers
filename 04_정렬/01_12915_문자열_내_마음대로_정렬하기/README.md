...
```bash
python3 tools/judge.py "04_정렬/01_12915_문자열_내_마음대로_정렬하기"
```

채점기는 `strings`, `n` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "04_정렬/01_12915_문자열_내_마음대로_정렬하기/solution.py"
```
