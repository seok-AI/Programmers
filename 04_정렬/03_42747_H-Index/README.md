...
```bash
python3 tools/judge.py "04_정렬/03_42747_H-Index"
```

채점기는 `citations` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "04_정렬/03_42747_H-Index/solution.py"
```
