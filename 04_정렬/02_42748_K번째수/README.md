...
```bash
python3 tools/judge.py "04_정렬/02_42748_K번째수"
```

채점기는 `array`, `commands` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "04_정렬/02_42748_K번째수/solution.py"
```
