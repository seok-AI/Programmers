...
```bash
python3 tools/judge.py "01_해시/04_42577_전화번호_목록"
```

채점기는 `phone_book` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "01_해시/04_42577_전화번호_목록/solution.py"
```
