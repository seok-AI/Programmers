...
```bash
python3 tools/judge.py "01_해시/06_42579_베스트앨범"
```

채점기는 `genres`, `plays` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "01_해시/06_42579_베스트앨범/solution.py"
```
