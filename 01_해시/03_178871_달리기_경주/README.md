...
```bash
python3 tools/judge.py "01_해시/03_178871_달리기_경주"
```

채점기는 `players`, `callings` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "01_해시/03_178871_달리기_경주/solution.py"
```
