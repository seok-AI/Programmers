...
```bash
python3 tools/judge.py "06_탐욕법/01_135808_과일_장수"
```

채점기는 `k`, `m`, `score` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "06_탐욕법/01_135808_과일_장수/solution.py"
```
