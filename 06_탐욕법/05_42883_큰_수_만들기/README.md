...
```bash
python3 tools/judge.py "06_탐욕법/05_42883_큰_수_만들기"
```

채점기는 `number`, `k` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "06_탐욕법/05_42883_큰_수_만들기/solution.py"
```
