...
```bash
python3 tools/judge.py "06_탐욕법/03_42885_구명보트"
```

채점기는 `people`, `limit` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "06_탐욕법/03_42885_구명보트/solution.py"
```
