...
```bash
python3 tools/judge.py "10_그래프/01_67256_키패드_누르기"
```

채점기는 `numbers`, `hand` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "10_그래프/01_67256_키패드_누르기/solution.py"
```
