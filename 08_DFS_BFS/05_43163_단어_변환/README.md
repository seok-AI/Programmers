...
- 함수: `solution(begin, target, words)`
...
```bash
python3 tools/judge.py "08_DFS_BFS/05_43163_단어_변환"
```

채점기는 `begin`, `target`, `words` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "08_DFS_BFS/05_43163_단어_변환/solution.py"
```
