...
```bash
python3 tools/judge.py "08_DFS_BFS/04_43162_네트워크"
```

채점기는 `n`, `computers` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "08_DFS_BFS/04_43162_네트워크/solution.py"
```
