...
```bash
python3 tools/judge.py "08_DFS_BFS/08_84021_퍼즐_조각_채우기"
```

채점기는 `game_board`, `table` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "08_DFS_BFS/08_84021_퍼즐_조각_채우기/solution.py"
```
