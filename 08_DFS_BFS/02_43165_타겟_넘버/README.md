...
```bash
python3 tools/judge.py "08_DFS_BFS/02_43165_타겟_넘버"
```

채점기는 `numbers`, `target` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "08_DFS_BFS/02_43165_타겟_넘버/solution.py"
```
