...
- 함수: `solution(rectangle, characterX, characterY, itemX, itemY)`
- 포함된 테스트: 공식 공개 예제 5개 + 자체 경계 사례 2개
...
```bash
python3 tools/judge.py "08_DFS_BFS/06_87694_아이템_줍기"
```

채점기는 `rectangle`, `characterX`, `characterY`, `itemX`, `itemY` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "08_DFS_BFS/06_87694_아이템_줍기/solution.py"
```
