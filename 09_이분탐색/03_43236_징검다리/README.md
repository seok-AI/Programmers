...
```bash
python3 tools/judge.py "09_이분탐색/03_43236_징검다리"
```

채점기는 `distance`, `rocks`, `n` 순서로 함수를 호출합니다. `tests.json`은 공개 예제,
...
```bash
python3 "09_이분탐색/03_43236_징검다리/solution.py"
```
